...
var ServerlessCustomDomain = /** @class */ (function () {
    ...
    ServerlessCustomDomain.prototype.setupBasePathMapping = function () {
        return __awaiter(this, void 0, void 0, function () {
            var apiId, currentBasePath, domainInfo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getApiId()];
                    case 1:
                        apiId = _a.sent();
                        return [4 /*yield*/, this.getBasePathMapping(apiId)];
                    case 2:
                        currentBasePath = _a.sent();
                        if (!!currentBasePath) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.createBasePathMapping(apiId)];
                    case 3:
                        _a.sent();
                        return [3 /*break*/, 6];
    ...
    ServerlessCustomDomain.prototype.initializeVariables = function () {
        ...
        if (this.enabled) {
            ...
            var apiTypeWithDefault = this.serverless.service.custom.customDomain.apiType ||
                apiTypes.rest;
            var apiTypeToUse = apiTypes[apiTypeWithDefault.toLowerCase()];
            if (!apiTypeToUse) {
    ...
    ServerlessCustomDomain.prototype.createCustomDomain = function (certificateArn) {
        return __awaiter(this, void 0, void 0, function () {
            var createdDomain, params, err_5, params, err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        createdDomain = {};
                        if (!(this.apiType === "REST")) return [3 /*break*/, 5];
                        params = {
                    ...
                    case 5:
                        if (!(this.apiType === "HTTP" || this.apiType === "WEBSOCKET")) return [3 /*break*/, 9];
                        params = {
                            DomainName: this.givenDomainName,
                    ...
                    case 6:
                        _a.trys.push([6, 8, , 9]);
                        return [4 /*yield*/, this.apigatewayV2.createDomainName(params).promise()];
                    case 7:
                        // If creating REST api use v1 of api gateway, else use v2 for HTTP and Websocket
                        createdDomain = _a.sent();
                        return [3 /*break*/, 9];
                    case 8:
                        ...
                        throw new Error("Error: Failed to create custom domain " + this.givenDomainName + "\n");
                    case 9: return [2 /*return*/, new DomainInfo(createdDomain)];
                }
            });
        });
    };
    ...
    ServerlessCustomDomain.prototype.changeResourceRecordSet = function (action, domain) {
        return __awaiter(this, void 0, void 0, function () {
            var createRoute53Record, route53HostedZoneId, Changes, params, err_8;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    ServerlessCustomDomain.prototype.getRoute53HostedZoneId = function () {
        return __awaiter(this, void 0, void 0, function () {
            var filterZone, hostedZoneData, givenDomainNameReverse, targetHostedZone, hostedZoneId, startPos, endPos, err_9;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    ServerlessCustomDomain.prototype.getBasePathMapping = function (restApiId) {
        return __awaiter(this, void 0, void 0, function () {
            var basepathInfo, currentBasePath, params, err_10, _i, _a, basepathObj, params, err_11, _b, _c, basepathObj;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 5:
                        if (!(this.apiType === "HTTP" || this.apiType === "WEBSOCKET")) return [3 /*break*/, 10];
                        params = {
                            DomainName: this.givenDomainName
                        };
                        _d.label = 6;
                    case 6:
                        _d.trys.push([6, 8, , 9]);
                        return [4 /*yield*/, this.apigatewayV2.getApiMappings(params).promise()];
                    case 7:
                        basepathInfo = _d.sent();
                        return [3 /*break*/, 9];
                    case 8:
                    ...
                    case 9:
                        if (basepathInfo.Items !== undefined && basepathInfo.Items instanceof Array) {
                            for (_b = 0, _c = basepathInfo.Items; _b < _c.length; _b++) {
                                basepathObj = _c[_b];
    ...
    ServerlessCustomDomain.prototype.createBasePathMapping = function (restApiId) {
        return __awaiter(this, void 0, void 0, function () {
            var params, resp, err_12, params, err_13;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.apiType === "REST")) return [3 /*break*/, 5];
                    ...
                    case 6:
                        _a.trys.push([6, 8, , 9]);
                        return [4 /*yield*/, this.apigatewayV2.createApiMapping(params).promise()];
                    case 7:
                        _a.sent();
                        this.serverless.cli.log("Created basepath mapping.");
                        return [3 /*break*/, 9];
     ...
     */
    ServerlessCustomDomain.prototype.getApiId = function () {
        return __awaiter(this, void 0, void 0, function () {
            var stackFamilyName, LogicalResourceId, allStackDescriptions, nextToken, params, describeStacksResponse, _i, _a, stackDescription, err_15, familyStackNames, response, _b, familyStackNames_1, familyStackName, err_16, apiId;
